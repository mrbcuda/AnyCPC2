...
switch shapeNumber
    ...
    case 2
        ...
        g_absorber = [g_absorber,[radius*cos(theta);65/2+radius*sin(theta)]];
        end;
    ...
    case 10
        ...
        g_absorber = [g_absorber,g_unitLength*[2*cos(pi/6);2*sin(pi/6)]];
        g_absorber = [g_absorber,g_unitLength*[0;2*sin(pi/6)]];
    ...
    case 16
        ...
        bottomPoint=-102/2-0.5;
        g_absorber = [0;bottomPoint];
        for theta = 2*pi/6+3/2*pi:2*pi/6:(2+.5)*pi
            g_absorber = [g_absorber,[radius*cos(theta);radius*sin(theta)]];
        end
end
